...
<body style="width:1366;height:auto;background-image:url(&quot;assets/img/36588536-blur-images.jpg&quot;);background-repeat:repeat;background-size:cover;">
    <div style="width:1366;height:auto;">
        ...
        <div class="col-md-4" style="width:700px;padding:0;max-width:none;height:auto;">
            <h1 style="color:#243e9c;">Update a Question</h1>
			...
			<form action="updateQuestion?qid=<%=question.getqid() %>" name="askQuestion" method ="post" title="Update a question">
				<table>
					
					<tr>
						<td>Type your question here :</td>
						<td><textarea rows="10" cols="50" name="updatedQuestion"><%=question.getQuery()%></textarea></td> 
