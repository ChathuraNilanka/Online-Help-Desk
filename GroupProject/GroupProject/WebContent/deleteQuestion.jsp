...
<body style="width:1366;height:auto;background-image:url(&quot;assets/img/36588536-blur-images.jpg&quot;);background-repeat:repeat;background-size:cover;">
    <div style="width:1366;height:auto;">
        ...
        <div class="col-md-4" style="width:700px;padding:0;max-width:none;height:auto;">
            <h1 style="color:#243e9c;">Delete Question</h1>
			<%Question question = new Question();
			IQuestion iq = new IQuestionImpl(); 
			question.setQid(request.getParameter("qId"));
			iq.viewSingleQuery(question); %>

			<h4><%=question.getQuery()%></h4>
			<h3>Do you want to delete this question ?</h3>
			<form action="deleteQuestion?qid=<%=question.getqid() %>" name="deleteQuestion" method ="post" title="Delete a question">
				<table>
					<tr>
					<td><input type="submit" value="Confirm"></td> 
					<td> <a href="viewQuestion.jsp?qId=<%=question.getqid()%>">Back to Question Page</a></td>
					</tr>
				</table>
			</form>
        </div>
