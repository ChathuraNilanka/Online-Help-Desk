    ...
    <div style="width:1366;height:auto;">
        ...
        <div class="col-md-4" style="width:700px;padding:0;max-width:none;height:auto;">
            <h1 style="color:#243e9c;">View a Solution</h1>
				<form action = "QuestionParameterized" method = get>
enter User id <input type = "text" name = "UserId">
<input type = "submit" value = "Click to view the report">
</form>
					
					</br>
					<a class="btn headbutton btn-primary btn-lg" href="QuestionNonParam" role="button">View Non Parameterized</a>
					</br>
        </div>
    </div>
    </div>
