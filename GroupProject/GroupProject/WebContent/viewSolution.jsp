<%@page import="GroupProject.Model.Question"%>
...
<body style="width:1366;height:auto;background-image:url(&quot;assets/img/36588536-blur-images.jpg&quot;);background-repeat:repeat;background-size:cover;">
    <div style="width:1366;height:auto;">
        <div class="container" style="width:1366px;margin:0;margin-top:0;padding:0;max-width:none;">
            ...
            <div
                ...
                <div class="col-md-4" style="width:300px;padding:0;margin:0px;padding-left:0px;max-width:300px;">
                    <div class="row" style="width:300px;margin:0;margin-top:0;padding-left:0;margin-left:0;"><a href="showNotices.jsp" data-bs-hover-animate="pulse" style="color:rgb(2,6,11);background-color:rgba(0,0,0,0.1);font-size:31px;font-family:'Alegreya Sans SC', sans-serif;padding-left:0;padding-right:0;width:300px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Home &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</a></div>
                    <div
        ...
        <div class="col-md-4" style="width:700px;padding:0;max-width:none;height:auto;">
            <h1 style="color:#243e9c;">View a Solution</h1>
			...
			%>
				...
				<table align="center">
					...
					<tr>
					   <td>Question :</td>
					   <td><%=question.getQuery()%></td>
					</tr>
					<tr>
						<td>Solution :</td>
						<td><%=solution.getSolution()%>
					<br/>
					<tr>
						<td> <a href="updateSolution.jsp?qId=<%=question.getqid()%>">Edit Solution</a></td>
						<td> <a href="deleteSolution.jsp?qId=<%=question.getqid()%>">Delete Solution</a></td>  
					</tr>
