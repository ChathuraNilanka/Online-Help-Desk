...
<body style="width:1366;height:auto;background-image:url(&quot;assets/img/36588536-blur-images.jpg&quot;);background-repeat:repeat;background-size:cover;">
    <div style="width:1366;height:auto;">
        ...
        <div class="col-md-4" style="width:700px;padding:0;max-width:none;height:auto;">
            <h1 style="color:#243e9c;">Update a Notice</h1>
			<%Notice notice = new Notice();
			INoticeService ins = new NoticeServiceImpl(); 
			notice.setNoticeID(request.getParameter("noticeID"));
			ins.viewSingleNotice(notice);
			%>


			<form action="updateNotice?noticeID=<%=notice.getNoticeID() %>" name="updateNotice" method ="post" title="Update a Notice">
				<table>
					
					<tr>
						<td>Type your Notice here :</td>
						<td><textarea rows="10" cols="50" name="updatedNotice"><%=notice.getNoticeContent()%></textarea></td> 
						
					</tr>
					<tr><td><input type="submit" value="Save Notice"></td> </tr>
				</table>
			</form>
        </div>
    </div>
