...
<body style="width:1366;height:auto;background-image:url(&quot;assets/img/36588536-blur-images.jpg&quot;);background-repeat:repeat;background-size:cover;">
    <div style="width:1366;height:auto;">
        ...
        <div class="col-md-4" style="width:700px;padding:0;max-width:none;height:auto;">
            <h1 style="color:#243e9c;">List of Questions</h1>
			<table border="1" cellpadding="12" align="center">
            <%
            ISolution is = new ISolutionImpl();
			ArrayList<Question> arrayList = is.getQuestions();
			
			for(Question question : arrayList){
			%>
			 <tr>
				<td> <%=question.getQuery() %> </td>
			<%boolean status = is.checkSolutionIsNull(question);%>
          	<%if(status == true) { %>
                 <td> <a href="submitSolution.jsp?qId=<%=question.getqid()%>">Submit Solution</a></td>
          	<% }  else { %>
          		<td> <a href="viewSolution.jsp?qId=<%=question.getqid()%>">View Solution</a></td>
          		<% } %>
