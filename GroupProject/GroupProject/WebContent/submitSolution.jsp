...
<body style="width:1366;height:auto;background-image:url(&quot;assets/img/36588536-blur-images.jpg&quot;);background-repeat:repeat;background-size:cover;">
    <div style="width:1366;height:auto;">
        ...
        <div class="col-md-4" style="width:700px;padding:0;max-width:none;height:auto;">
            <h1 style="color:#243e9c;">Submit Solution</h1>
			...
			iq.viewSingleQuery(question); %>
				...
				<form action="addSolution?qId=<%=question.getqid()%>" name="askQuestion" method ="post" title="ask a question">
				<table>
					<tr>
						<td>Type your Solution here :</td>
						<td><textarea rows="10" cols="50" name="solution"></textarea></td>
					</tr>
					<tr><td><input type="submit" value="Save and Submit"></td> </tr>
				</table>
			</form>
        </div>
    </div>
