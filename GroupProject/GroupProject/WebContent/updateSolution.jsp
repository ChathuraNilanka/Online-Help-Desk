<%@page import="GroupProject.Model.Solution"%>
...
<body style="width:1366;height:auto;background-image:url(&quot;assets/img/36588536-blur-images.jpg&quot;);background-repeat:repeat;background-size:cover;">
    <div style="width:1366;height:auto;">
        <div class="container" style="width:1366px;margin:0;margin-top:0;padding:0;max-width:none;">
            ...
            <div
                ...
                <div class="col-md-4" style="width:300px;padding:0;margin:0px;padding-left:0px;max-width:300px;">
                    <div class="row" style="width:300px;margin:0;margin-top:0;padding-left:0;margin-left:0;"><a href="viewAskedQuestions.jsp" data-bs-hover-animate="pulse" style="color:rgb(2,6,11);background-color:rgba(0,0,0,0.1);font-size:31px;font-family:'Alegreya Sans SC', sans-serif;padding-left:0;padding-right:0;width:300px;">&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;Home &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;&nbsp;</a></div>
                    <div
        ...
        <div class="col-md-4" style="width:700px;padding:0;max-width:none;height:auto;">
            <h1 style="color:#243e9c;">Update a Solution</h1>
			<%Solution solution = new Solution();
			ISolution is = new ISolutionImpl(); 
			solution.setqId(request.getParameter("qId"));
			is.viewSingleSolution(solution); %>


			<form action="updateSolution?qid=<%=solution.getqId() %>" name="askQuestion" method ="post" title="Update a question">
				<table>
					
					<tr>
						<td>Type your solution here :</td>
						<td><textarea rows="10" cols="50" name="updatedSolution"><%=solution.getSolution()%></textarea></td> 
						
					</tr>
					<tr><td><input type="submit" value="Save Question"></td> </tr>
				</table>
			</form>
        </div>
    </div>
